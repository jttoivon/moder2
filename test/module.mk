...
TEST_PROGRAMS2=test_suffix_array_wrapper test_kmer_tools test_packed_string test_dinucleotide test_multinomial test_common test_count_object
...
test/test_count_object.o: count_object.hpp
...
TEST_ALL_SOURCES=test/test_main.cpp test/test_dinucleotide.cpp test/test_probabilities.cpp test/test_suffix_array_wrapper.cpp test/test_common.cpp\
test/test_count_object.cpp
test/test_main: $(TEST_ALL_OBJS) $(TEST_ALL_SOURCES:.cpp=.o)
	$(CXX) $(TESTCXXFLAGS) $+ -o test/test_main  $(TESTLDFLAGS)
